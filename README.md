...
| :--- | :---: | :---: | :---: | :---: | :---: |
| 📝 **일반 텍스트 (Text)** | 100.04% | 6.84% | **10.14%** | 3.35% | 3.49% |
| 🎧 **오디오 파일 (Audio)** | 100.04% | 83.71% | **37.90%** 🏆 | 75.73% | 70.06% |
| 🖼️ **이미지 파일 (Image)** | 100.04% | 5.85% | **8.19%** | 3.86% | 5.02% |
| 💻 **실행 파일 (Executable)** | 100.04% | 94.37% | **84.53%** | 82.90% | 75.41% |

> [!TIP]
> **오디오 데이터셋의 독보적인 압축률**: 오디오 파일(16-bit PCM WAV)의 경우, MZC7에 탑재된 **LPC(선형 예측) 필터**와 **산술 레인지 코더**의 결합을 통해 업계 표준인 Gzip(75.73%) 및 Zstd(70.06%) 대비 **37.90%**라는 압축 효율을 달성하여 압도적인 성능적 우위를 보여줍니다.
