...
./target/release/mzc decompress output_file.mzc6 restored_file.bin
...
### 4.4 CLI 파일 검사 및 상세 정보 진단 (`inspect`)
```bash
./target/release/mzc inspect output_file.mzc6
```

### 4.5 데스크톱 GUI 진단 대시보드 기동 (`gui`)
```bash
