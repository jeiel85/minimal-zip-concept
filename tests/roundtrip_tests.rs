...
fn assert_roundtrip(original: &[u8]) {
    ...
    let compressed_hybrid = mzc::compress_bytes_v2(original, CompressionMode::Hybrid, EntropyMode::Huffman, 6, false, false);
    ...
    let compressed_rle = mzc::compress_bytes_v2(original, CompressionMode::Rle, EntropyMode::None, 6, false, false);
    ...
    let compressed_lz77_huff = mzc::compress_bytes_v2(original, CompressionMode::Lz77, EntropyMode::Huffman, 6, false, false);
    ...
    let compressed_lz77_none = mzc::compress_bytes_v2(original, CompressionMode::Lz77, EntropyMode::None, 6, false, false);
    ...
    let compressed_lz77_dyn = mzc::compress_bytes_v2(original, CompressionMode::Lz77, EntropyMode::Dynamic, 6, false, false);
    ...
    let compressed_hybrid_dyn = mzc::compress_bytes_v2(original, CompressionMode::Hybrid, EntropyMode::Dynamic, 6, false, false);
    ...
    let compressed_mzc5 = mzc::compress_bytes_v2(original, CompressionMode::Lz77, EntropyMode::Dynamic, 9, true, true);
...
fn test_dynamic_huffman_header_savings() {
    ...
    let compressed_static = mzc::compress_bytes_v2(input, CompressionMode::Hybrid, EntropyMode::Huffman, 6, false, false);
    let compressed_dynamic = mzc::compress_bytes_v2(input, CompressionMode::Hybrid, EntropyMode::Dynamic, 6, false, false);
